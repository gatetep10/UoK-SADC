            ...
            <div class="card"> 
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" placeholder = "E.g. Manager" value = "{{old('name')}}">
                        @if ($errors -> has('name'))
                        <span class="text-danger">{{$errors ->first('name')}}</span>
                        @endif
                    </div>
                    <label for="assign_permission" class="form-label">Assign Permissions <span class="text-danger"></span></label>
                    <div class="table-responsive">
                        <table id = "tblData" class = "table table-bordered table-striped dataTable dtr-inline collapsed">
                            <thead>
                                <tr>
                                    <th><input type="checkbox" name="all_permission" id="all_permission"></th>
                                    <th>Name</th>
                                    <th>Guard</th>
                                </tr>
                            </thead>
...
<script>
    ...
    $(document).ready(function(){
        //Check and uncheck all permissions function
