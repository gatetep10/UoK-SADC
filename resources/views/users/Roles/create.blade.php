...
<script>
    ...
    $(document).ready(function(){
        ...
        var table = $('#tblData').DataTable({
            reponsive:true, processing:true, searchable:true, serverSide:true, autoWidth:false, bPaginate:true, bFilter:true,
            ajax:"{{route('users.permissions.index')}}", 
            columns:[
                {data:'chkBox', name:'chkBox', orderable:false, searchable:true, className:'text-center'},
                {data:'name', name:'name'},
